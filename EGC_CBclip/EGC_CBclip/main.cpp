...
void initClipWindow()
{
	clipWindow.push_back(vec3(400.0f, 150.0f, 1.0f));
	clipWindow.push_back(vec3(250.0f, 300.0f, 1.0f));
	clipWindow.push_back(vec3(300.0f, 450.0f, 1.0f));
	clipWindow.push_back(vec3(500.0f, 450.0f, 1.0f));
	clipWindow.push_back(vec3(550.0f, 300.0f, 1.0f));
